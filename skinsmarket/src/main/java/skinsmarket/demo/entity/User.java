...
public class User implements UserDetails {
    ...
    /**
     * Alias de cobro del vendedor (CBU/CVU/billetera virtual).
     * Se usa como dato de pago para acreditar ventas fuera del saldo interno.
     * La columna mantiene su nombre anterior para no perder datos ya guardados.
     */
    @Column(name = "alias_mercado_pago", length = 100)
